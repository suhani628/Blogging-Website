...
.cat{color:white;font-weight:bold;font-size:30px;padding-left:75px;}
.cat:hover{color:#BA68C8;}
</style>
</head>
<body>
<!-- navbar -->
<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#"><span class="	fa fa-globe"></span>&nbsp;Discover</a>
        </li>
        <li class="nav-item">
 ...
 <div class="list-group">
  <a href="#" onclick="getposts(0,this)"  class=" clink list-group-item  list-group-item-action active ">
    All posts
  </a>
  <%
  ...
  for(category cc:list1){
	%>   
  <a href="#" onclick="getposts(<%= cc.getCid() %>,this)" class=" clink list-group-item  list-group-item-action"><%= cc.getName() %></a>
  <%
  }
  %>
</div>
...
<div class="container-flid" id="postcontainer"></div>
</div>
 </div>
 </div>
 </main>
